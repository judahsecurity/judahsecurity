...
PLAYBOOKS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "objective": (
            ...
            "   - OpenAPI/Swagger → execute_astf (API Top 10) + schemathesis; REST APIs → authz checks + kiterunner leftovers\n"
    ...
    },
    {
        ...
        "objective": (
            ...
            "API→execute_astf + schemathesis, chatbot→llm_red_team).\n\n"
    ...
    },
    {
        ...
        "objective": (
            ...
            "4) OpenAPI/Swagger: GET /api/schema/ (or swagger.json). Hunt operations with "
            ...
            "8) Save non-findings and exhausted endpoints with save_note so future runs skip them."
        ),
        "initial_todos": [
