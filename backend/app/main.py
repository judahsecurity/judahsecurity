...
from app.models.wiz_integration import WizIntegration  # noqa: F401 — ensure table is created
...
def apply_oracle_migrations():
    ...
    ddl_statements = [
        ...
        "ALTER TABLE custom_nuclei_templates ADD COLUMN IF NOT EXISTS content_digest VARCHAR(64)",
        "ALTER TABLE custom_nuclei_templates ADD COLUMN IF NOT EXISTS released_at TIMESTAMP",
        "ALTER TABLE custom_nuclei_templates ADD COLUMN IF NOT EXISTS enabled_at TIMESTAMP",
